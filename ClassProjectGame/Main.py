...
=======
screen = pygame.display.set_mode((SCREENWIDTH, SCREENHEIGHT)) #Initialize a window or screen for display. Sets the size of the screen (640, 360), the flags 0, and the color 32.
...
=======
player = Player(0, SCREENHEIGHT - 40, 40, 40, "images/player1.png")
>>>>>>> 4f0195ad3fb02ac92182a0e47cf230d165c647df
...
while True:
	...
	Enemies.update_all(SCREENWIDTH)
